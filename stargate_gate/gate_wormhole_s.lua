...
function stargate_wormhole_create(stargateIDFrom, stargateIDTo)
    ...
    stargate_horizon_setActive(stargateIDFrom, 0, true)
    stargate_horizon_setActive(stargateIDTo, 0, true)
    stargate_vortex_animate(stargateIDFrom)
    local vortexTime = stargate_vortex_animate(stargateIDTo)
    local killZoneF = stargate_marker_create(x, y+2.6, z, "corona", 3, 25, 90 ,200, 25, enum_markerType.VORTEX, stargateIDFrom)
    local killZoneT = stargate_marker_create(x, y+2.6, z, "corona", 3, 25, 90 ,200, 25, enum_markerType.VORTEX, stargateIDTo)
...
function stargate_wormhole_close(stargateIDFrom, stargateIDTo)
    ...
    setTimer(function(stargateIDFrom, stargateIDTo)
        ...
        stargate_marker_remove(stargateIDTo, enum_markerType.EVENTHORIZON)
