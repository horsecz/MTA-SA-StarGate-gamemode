...
function initServer()
    ...
    newSG = stargate_create(enum_galaxy.MILKYWAY, 0, 0, 2.25, {15,11,9,19,25,32,39}, enum_stargateDialType.FAST, 90, 0, 0, false)
    newDHD = dhd_create(enum_galaxy.MILKYWAY, -2, 6, 1.7, 0, 0, 180, getElementID(newSG))

    newSG = stargate_create(enum_galaxy.MILKYWAY, 20, 0, 4, {1,3,5,7,9,11,39}, enum_stargateDialType.SLOW, 0, 0, 0, false, true)
    newDHD = dhd_create(enum_galaxy.MILKYWAY, 22, 6, 1.7, 0, 0, 210, getElementID(newSG))

    newSG = stargate_create(enum_galaxy.MILKYWAY, -20, 0, 3, {1,2,3,4,5,6,39}, enum_stargateDialType.FAST, 45, 20, 45)
